...
function drawPipeline(){const {d,i,t}=labels();
  ...
  // Bypass path starts below the AI card and stays outside the review card.
  if(d>68&&(i<48||t<42))drawPolyline([[430,300],[508,354],[640,406]],'rgba(220,38,38,.50)',7,[12,8]);
}
...
function drawNodes(){
  ...
  ctx.fillStyle='rgba(255,255,255,.92)';ctx.strokeStyle='rgba(220,38,38,.60)';ctx.lineWidth=4;roundRect(600,396,164,76,22,true,true);
  haloText('Bypass risk',682,427,'900 14px Arial','#b91c1c');
  haloText('review skipped',682,450,'bold 12px Arial','#52677d')
}
...
function point(kind,t){
  ...
  return polyPoint([[430,300],[508,354],[640,406]],t)
}
